 ...
 * @author Alisha Gupta
 */
public class NewJFrameiphone6plus extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrameiphone6plus
     */
    public NewJFrameiphone6plus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("i phone 6 plus");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "8 gb rom", "16 gb rom", "32 gb rom", "64 gb" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "red ", "black", "matt black", "grey", "space grey", "platimun blue", "gold", "rose pink", "rose gold" }));
        ...
        jLabel12.setText("rate per piece rs 25999/- only");

        jLabel13.setIcon(new javax.swing.ImageIcon("C:\\Users\\Alisha Gupta\\Desktop\\ng\\apple-iphone-6-plus-64gb-review-a-classy-iphablet.jpg")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJFrameiphone6plus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJFrameiphone6plus().setVisible(true);
            }
        });
    }
